...
Download the five sample texts and save the ZIP file to your local computer: <a href="https://github.com/hksung/PythonTutorial/blob/main/corpus/sample.zip" download class="btn btn-primary"> Download the sample texts </a>
...
sample_folder = Path( "YOUR LOCAL PATH TO THE EXTRACTED SAMPLE FOLDER") 
