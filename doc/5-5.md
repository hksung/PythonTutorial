...
Choose one English text file containing at least 500 words.

You may use a text from a public source, your own writing, or another English corpus. Save the file in `.txt` format and place it in the `corpus` folder. To apply this exercise to another language, see [Applying the workflow to another language](5-6.html).

In this exercise, you will:

1. select English NLP tools;
...
Use the English spaCy pipeline from the preceding lessons:
...
Use the English pretrained model from the subword-tokenization lesson:

```python
SUBWORD_MODEL = "google-bert/bert-base-cased"
