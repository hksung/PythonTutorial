...
In this tutorial, we will first use [spaCy](https://spacy.io/) for linguistic tokenization and lemmatization. spaCy is a well-known NLP library that provides language-specific processing pipelines.
