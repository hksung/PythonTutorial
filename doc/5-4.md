...
Because the texts may have different lengths, raw counts are not enough. Calculate occurrences per 1,000 text units using $\text{count} / \text{total units} \times 1000$.
...
Apply the function separately to the two lemma-frequency lists. Use the number of retained lemmas in each text as the denominator.
